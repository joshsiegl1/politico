...
namespace MenuSystem
{
    ...
    public class MenuEntry
    {
        ...
        /// </summary>
        protected Vector2 position = new Vector2(0, -500);

        /// <summary>
        /// The Color of the font when it is not selected
        /// </summary>
        protected Color fontColor;

        /// <summary>
        /// The font used for this menuEntry
        /// </summary>
        ...
        /// <summary>
        /// Gets the text of the current menu entry 
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Gets or sets the color of the font when it is not selected
        /// </summary>
        ...
        /// <summary>
        /// Should this MenuEntry have a black outline
        /// </summary>
        ...
        public virtual void Draw(MenuScreen screen, bool isSelected, GameTime gameTime, bool fade)
        {
            ...
            Color color = fontColor; //isSelected ? Color.Yellow : fontColor;
        ...
        /// <summary>
        /// allows an entry to reset itself
        /// </summary>
